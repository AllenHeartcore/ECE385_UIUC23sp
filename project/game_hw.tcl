...
set_module_property DISPLAY_NAME "Game Controller"
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL Game
set_fileset_property QUARTUS_SYNTH ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property QUARTUS_SYNTH ENABLE_FILE_OVERWRITE_MODE false
add_fileset_file game.sv SYSTEM_VERILOG PATH src/game.sv TOP_LEVEL_FILE
add_fileset_file i2s.sv SYSTEM_VERILOG PATH src/i2s.sv
add_fileset_file vga.sv SYSTEM_VERILOG PATH src/vga.sv
add_fileset_file utils.sv SYSTEM_VERILOG PATH src/utils.sv
add_fileset_file layer_bg.sv SYSTEM_VERILOG PATH src/layer_bg.sv
add_fileset_file layer_fig.sv SYSTEM_VERILOG PATH src/layer_fig.sv
add_fileset_file layer_kbd.sv SYSTEM_VERILOG PATH src/layer_kbd.sv
add_fileset_file layer_txt.sv SYSTEM_VERILOG PATH src/layer_txt.sv

add_fileset SIM_VERILOG SIM_VERILOG "" ""
set_fileset_property SIM_VERILOG TOP_LEVEL Game
set_fileset_property SIM_VERILOG ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property SIM_VERILOG ENABLE_FILE_OVERWRITE_MODE false
add_fileset_file game.sv SYSTEM_VERILOG PATH src/game.sv
add_fileset_file i2s.sv SYSTEM_VERILOG PATH src/i2s.sv
add_fileset_file vga.sv SYSTEM_VERILOG PATH src/vga.sv
add_fileset_file utils.sv SYSTEM_VERILOG PATH src/utils.sv
add_fileset_file layer_bg.sv SYSTEM_VERILOG PATH src/layer_bg.sv
...
add_interface_port avl_mm_slave avl_rden read Input 1
add_interface_port avl_mm_slave avl_wren write Input 1
add_interface_port avl_mm_slave avl_cs chipselect Input 1
add_interface_port avl_mm_slave avl_addr address Input 6
add_interface_port avl_mm_slave avl_wdata writedata Input 8
add_interface_port avl_mm_slave avl_rdata readdata Output 8
...
add_interface I2S_port conduit end
set_interface_property I2S_port associatedClock clk
set_interface_property I2S_port associatedReset ""
set_interface_property I2S_port ENABLED true
set_interface_property I2S_port EXPORT_OF ""
set_interface_property I2S_port PORT_NAME_MAP ""
set_interface_property I2S_port CMSIS_SVD_VARIABLES ""
set_interface_property I2S_port SVD_ADDRESS_GROUP ""

add_interface_port I2S_port sclk sclk Input 1
add_interface_port I2S_port lrclk lrclk Input 1
add_interface_port I2S_port din din Output 1
add_interface_port I2S_port dout dout Input 1
